...
// Truy cập vào ToastService thông qua getCurrentInstance
const { appContext } = getCurrentInstance()
const toast = appContext.config.globalProperties.$toast // Truy cập ToastService
...
<template>
  ...
  <!-- Thêm Toast component để hiển thị thông báo -->
  <Toast />
</template>
